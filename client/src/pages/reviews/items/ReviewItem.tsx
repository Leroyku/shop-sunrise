      ...
      <div className={styles.item}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.ccontent}>
            ...
            <p className={styles.description}>
              Хочу выразить огромную благодарность от всей команды Bikini Bottom. Шеврон получился
      ...
      <div className={styles.item}>
        <div className={styles.card}>
          ...
          <div className={styles.ccontent}>
            ...
            <p className={styles.description}>
              Покупаю периодически шары и разные ништяки, продавец проверен временем и качеством.
              Цены не ломит, говорит как есть, а не втюхивает. В общем рекомендую!
            </p>
          </div>
        </div>
        <div className={styles.card}>
