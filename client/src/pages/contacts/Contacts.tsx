...
const Contacts: React.FC = () => {
  ...
  return (
    <div className={styles.root}>
      <Helmet>
        <title>Контакты страйкбольной лавки SunRise</title>
        <meta
          name="description"
          content="Контакты страйкбольной лавки Sunrise. Телеграм, Почта, ВКонтакте"
        />
        <meta name="keywords" content="Sunrise Санрайз Страйкбол Airsoft контакты телефон" />
      </Helmet>
          ...
          <div className={styles.block}>
            <div className={styles.text}>
              ...
              <div className={styles.medias}>
                <a target="_blank" href="https://vk.com/im?media=&sel=739581589">
                  <FontAwesomeIcon icon={faVk} />
                </a>
                <a target="_blank" href="https://t.me/+79506249285">
                  <FontAwesomeIcon icon={faTelegram} />
                </a>
                <a target="_blank" href="https://wa.me/79506249285">
                  <FontAwesomeIcon icon={faWhatsapp} />
                </a>
                <a target="_blank" href="viber://chat?number=%2B79506249285">
